...
class TbGenerateList():
	def __init__(self):
		...
		fileObj.write('\n<h1>'+tbName.capitalize()+' '+action.capitalize()+'</h1>')
		...
		fileObj.write('\n var titlePage = "'+tbName.capitalize()+' '+action.capitalize()+'"; var siteName = "'+siteName+'"; document.title = titlePage + \" | \" + siteName;');
